      ...
      <main className="flex-grow">
        ...
        <section id="about" className="py-32 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-16">
              ...
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">01 / Perspective</h2>
        ...
        <section id="how-i-work" className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-12">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">02 / Operational Strategy</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
            <div className="glass p-8 md:p-14 rounded-[2.5rem] border-blue-500/10">
                {HOW_I_WORK.map((howIWork, idx) => (
                  <p key={idx} className="text-lg md:text-xl font-light leading-relaxed text-neutral-300 mb-6 last:mb-0 relative pl-5" >
                    <span class="absolute -left-0 top-3 -translate-x-1/2 w-2 h-2 rounded-full bg-blue-500 shadow-[0_0_20px_rgba(59,130,246,0.8)] z-10"></span> {howIWork}
                  </p>
                ))}
            </div>
          </div>
        ...
        <section id="arch-thinking" className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-12">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">03 / System & Architecture Thinking</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
            <div className="glass p-8 md:p-14 rounded-[2.5rem] border-blue-500/10 bg-white/[0.01]">
        ...
        <section id="technical-capabilities" className="py-24 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-6 mb-16">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono"> 04 / Technical Capabilities</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
        ...
        <section id="strengths" className="py-24 px-6">
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center gap-6 mb-16">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">05 / Core Impact Matrix</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
        ...
        <section id="internal-tools-philosophy" className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-12">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">06 / Building Internal Tools That Matter</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
        ...
        <section id="lab-teaser" className="py-32 px-6">
          <div className="max-w-6xl mx-auto">
             <div className="flex items-center gap-6 mb-16">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">07 / Product Lab Hub</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
        ...
        <section id="work" className="py-32 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center gap-6 mb-12">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">08 / Architecture Selected</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {SYSTEMS.map((system, idx) => (
                <ProjectCard key={idx} project={system} />
              ))}
            </div>
          </div>
        </section>
        ...
        {/* 09 / Career Matrix */}
        <section id="experience" className="py-32 px-6 bg-white/[0.005]">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-20">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">09 / Career Matrix</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
        ...
        <section id="education" className="py-32 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-6 mb-16">
              <div className="h-px flex-1 bg-gradient-to-r from-transparent to-blue-500/50"></div>
              <h2 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono">10 / Academic Foundation</h2>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-blue-500/50"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {EDUCATION.map((edu, idx) => (
                <div key={idx} className="glass p-12 rounded-[2.5rem] group hover:border-blue-500/40 transition-all duration-500">
                  <span className="mono text-blue-500 text-[11px] uppercase tracking-widest block mb-4 font-bold">{edu.period}</span>
                  <h3 className="text-3xl font-bold mb-3 group-hover:text-blue-400 transition-colors tracking-tight">{edu.degree}</h3>
                  <p className="text-neutral-500 font-light italic text-lg">{edu.institution}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="contact" className="py-40 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="mb-16 text-center">
              <h3 className="text-xs uppercase tracking-[0.5em] text-blue-500 mono mb-8 font-bold">11 / Protocol: Handshake</h3>
            ...
            <div className="glass rounded-[4rem] p-12 md:p-32 text-center relative overflow-hidden group border-blue-500/10">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-8">
                <a href="mailto:sakthivel@example.com" className="px-14 py-6 bg-white text-black font-bold rounded-full hover:scale-105 transition-all w-full md:w-auto text-center shadow-xl">
                  Primary Mailbox
                </a>
...
const Footer: React.FC = () => (
  <footer className="py-20 px-6 text-center border-t border-white/5 relative overflow-hidden bg-black">
    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
      <p className="mono text-[11px] uppercase tracking-[0.5em] text-neutral-700">
        SAKTHIVEL S // FULL STACK WEB DEVELOPER // {new Date().getFullYear()}
      </p>
      <div className="flex gap-4">
        <span className="text-[10px] text-neutral-800 mono tracking-widest uppercase">Production Systems Experience</span>
        <span className="text-[10px] text-neutral-800 mono tracking-widest uppercase">//</span>    
        <span className="text-[10px] text-neutral-800 mono tracking-widest uppercase">ERP & SaaS Focus</span>
      </div>
    </div>
  </footer>
);
