...
export const SocialMedia: React.FC<SocialMediaProps> = ({ className }) => {
  ...
  return (
    <div className={`flex gap-4 ${className}`}>
      ...
      {/* Instagram */}
      <a href="https://www.instagram.com/sakthivel14325?igsh=OHM1b256OTBzanVu" aria-label="View My Instagram Profile" target="_blank" rel="noreferrer" className={baseStyle}>
        <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5">
